...
-- GPT dispatch for control code
os.execute('curl -H "Authorization: token $GH_TOKEN" -d \'{"event_type": "control-gen", "client_payload": {"module": "\' .. evo_plan.next_module .. \'", "prompt": "Generate control flow from cog arch"}}\' https://api.github.com/repos/Strategickhaos/Strategickhaos-pipe-trades-cli/dispatches')
